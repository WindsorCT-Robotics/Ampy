...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("RaiseIntakeCommand", new RaiseIntakeCommand(IntakeArms.getInstance()));
    SmartDashboard.putData("LowerIntakeCommand", new LowerIntakeCommand(IntakeArms.getInstance()));
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
   operatorController.povUp().onTrue(new IntakeCommand(IntakeArms.getInstance()));
   operatorController.povDown().onTrue(new UntakeCommand(IntakeArms.getInstance()));
