...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    driveController.leftBumper().onTrue(new SequentialCommandGroup(new MoveIntakeCommand(ArmState.RAISED, intakeArms).until(() -> conveyor.isPiece())));
    driveController.rightBumper().onTrue(new MoveIntakeCommand(ArmState.LOWERED, intakeArms));
