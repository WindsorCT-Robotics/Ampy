...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("DriveCommand", new DriveCommand(() -> DriveConstants.DRIVE_FULL_SPEED,() -> DriveConstants.TURN_RADIUS));
    ...
    SmartDashboard.putData("TurnConveyorCommand", new TurnConveyorCommand(MotorConstants.CONVEYOR_FULL_SPEED, conveyor));
  ...
  private void configureButtonBindings() {
    ...
    velocityStick.onTrue(new DriveCommand(() -> DriveConstants.DRIVE_FULL_SPEED,() -> DriveConstants.TURN_RADIUS).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    SmartDashboard.putData("VelocityStick", new DriveCommand(() -> DriveConstants.DRIVE_FULL_SPEED,() -> DriveConstants.TURN_RADIUS));

    final JoystickButton turnStick = new JoystickButton(driveController, XboxController.Button.kRightStick.value);
    
    turnStick.onTrue(new DriveCommand(() -> DriveConstants.DRIVE_FULL_SPEED,() -> DriveConstants.TURN_RADIUS).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    SmartDashboard.putData("TurnStick", new DriveCommand(() -> DriveConstants.DRIVE_FULL_SPEED,() -> DriveConstants.TURN_RADIUS));
    ...
    final Trigger forwardConveyorButton = new Trigger(() -> driveController.getRawAxis(XboxController.Axis.kRightTrigger.value) > ControlConstants.SHOOT_TRIGGER_THRESHOLD);
    ...
    final Trigger reverseConveyorButton = new Trigger(() -> driveController.getRawAxis(XboxController.Axis.kLeftTrigger.value) > ControlConstants.SHOOT_TRIGGER_THRESHOLD);
    forwardConveyorButton.whileTrue(new TurnConveyorCommand(0, conveyor));
