...
public static final double TURN_RADIUS = 0.4; // 0.4 is the best arbitrary value picked by David McManus
    ...
    // here. Call these from Commands.
     public void togglePrecisionTurnMode(boolean precisionToggle) {
        if (!precisionToggle) {
            ...
            lPrimary.configOpenloopRamp(Drive.RAMP_TIME);
            rPrimary.configOpenloopRamp(Drive.RAMP_TIME);
            lSecondary.configOpenloopRamp(Drive.RAMP_TIME);
            rSecondary.configOpenloopRamp(Drive.RAMP_TIME);
        }
    }
